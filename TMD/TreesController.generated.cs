...
namespace TMD.Controllers {
    public partial class TreesController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult FindKnownSpeciesWithSimilarCommonName() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.FindKnownSpeciesWithSimilarCommonName);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult FindKnownSpeciesWithSimilarScientificName() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.FindKnownSpeciesWithSimilarScientificName);
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_TreesController: TMD.Controllers.TreesController {
        ...
        public override System.Web.Mvc.ActionResult FindKnownSpeciesWithSimilarCommonName(string term, int results) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.FindKnownSpeciesWithSimilarCommonName);
            callInfo.RouteValueDictionary.Add("term", term);
            callInfo.RouteValueDictionary.Add("results", results);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult FindKnownSpeciesWithSimilarScientificName(string term, int results) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.FindKnownSpeciesWithSimilarScientificName);
            callInfo.RouteValueDictionary.Add("term", term);
            callInfo.RouteValueDictionary.Add("results", results);
            return callInfo;
        }
