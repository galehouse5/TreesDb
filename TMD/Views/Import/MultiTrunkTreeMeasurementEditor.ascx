...
<div id='MultiTrunkTreeMeasurementEditor'>
    <form>
            ...
            <div id='MultiTrunkTreeMeasurementGeneralSection'>
                <div class='GeneralSection'>
                    ...
                    <div class="InputRow EnterCoordinates InputButton">
                        ...
                        <a href="javascript:MultiTrunkTreeMeasurementEditor.OpenCoordinatePicker(<%= Model.Trip.HasEnteredCoordinates ? "true" : "false" %>)" class="CoordinatePicker CoordinatesEntered">Pick coordinates</a>
                        <div class='ui-helper-clearfix'></div>
                    </div>
            ...
            <div id='MultiTrunkTreeMeasurementHeightSection'>
                <div class='HeightSection'>
                    ...
                    <div class="InputRow DistanceAndAngleMeasurementsEntered" style="float: left; margin-left: 100px">
                        <a href="javascript:MultiTrunkTreeMeasurementEditor.CalculateDetailedHeightMeasurements()" class="CalculateHeightAndOffset">Calculate height and offset</a>
                    </div>
                    <div class="InputRow DistanceAndAngleMeasurementsEntered">
            ...
            <div id='MultiTrunkTreeMeasurementGirthSection'>
                <div class='GirthSection'>
                    <div class="InputRow Girth">
                        <%= Html.LabelFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirth)%>
                        <%= Html.TextBoxFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirth)%>
                        <div class="ValidationError ui-state-error-text">
                            <%= Html.ValidationMessageFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirth, " ", new { @class = "ui-icon ui-icon-circle-close" })%>
                            <%= Html.ValidationMessageFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirth, "", new { @class = "ValidationErrorMessage" })%>
                        </div>
                        <div class="ui-helper-clearfix"></div>
                    </div>
                    <div class="InputRow Girth">
                        <%= Html.LabelFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirthNumberOfTrunks)%>
                        <%= Html.TextBoxFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirthNumberOfTrunks)%>
                        <div class="ValidationError ui-state-error-text">
                            <%= Html.ValidationMessageFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirthNumberOfTrunks, " ", new { @class = "ui-icon ui-icon-circle-close" })%>
                            <%= Html.ValidationMessageFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedGirthNumberOfTrunks, "", new { @class = "ValidationErrorMessage" })%>
                        </div>
                        <div class="ui-helper-clearfix"></div>
                    </div>
                    <div class="InputRow">
            ...
            <div id='MultiTrunkTreeMeasurementCrownSection'>
                <div class='CrownSection'>
                    <div class="InputRow CrownSpread">
                        <%= Html.LabelFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedCrownSpread)%>
                        <%= Html.TextBoxFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedCrownSpread)%>
                        <div class="ValidationError ui-state-error-text">
                            <%= Html.ValidationMessageFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedCrownSpread, " ", new { @class = "ui-icon ui-icon-circle-close" })%>
                            <%= Html.ValidationMessageFor(m => ((MultiTrunkTreeMeasurement)m.SelectedTreeMeasurement).CombinedCrownSpread, "", new { @class = "ValidationErrorMessage" })%>
                        </div>
                        <div class="ui-helper-clearfix"></div>
                    </div>
                    <div class="InputRow">
                ...
                <div class='TrunkSection'>
                    <div class="InputRow">
                        ...
                        <div class="ValidationError ui-state-error-text">
                            ...
                            <%= Html.ValidationMessageFor(m => m.SelectedTreeMeasurement.NumberOfTrunks, "", new { @class = "ValidationErrorMessage" })%>
                        </div>
                        <div class="ui-helper-clearfix"></div>
                    </div>
                    <div class="InputRow">
                    ...
                    <div class="InputRow">
                        ...
                        <%= Html.DropDownListFor(m => m.SelectedTreeMeasurement.FormType, ModelExtensions.BuildSelectList<MultiTrunkTreeFormType>())%>
                        <div class="ValidationError ui-state-error-text">
                            <%= Html.ValidationMessageFor(m => m.SelectedTreeMeasurement.FormType, " ", new { @class = "ui-icon ui-icon-circle-close" })%>
                            <%= Html.ValidationMessageFor(m => m.SelectedTreeMeasurement.FormType, "", new { @class = "ValidationErrorMessage" })%>
                        </div>
                        <div class='ui-helper-clearfix'></div>
                    </div>
                    <div class="InputRow">
    ...
    <div class='Step2'>
        <div class='InputColumn ui-widget-content ui-corner-all' style='width: 416px;'>
            <div style="padding-left: 5px;">
                <a class="ImportAddTrunkMeasurementButton" href='javascript:TrunkMeasurementEditor.Add({onClose: MultiTrunkTreeMeasurementEditor.Refresh})'>Add trunk measurement</a>
                <div class="ValidationError ui-state-error-text">
                    <%= Html.ValidationMessage("SelectedTreeMeasurement.TrunkMeasurements", " ", new { @class = "ui-icon ui-icon-circle-close" })%>
                    <%= Html.ValidationMessage("SelectedTreeMeasurement.TrunkMeasurements", "", new { @class = "ValidationErrorMessage" })%>
                </div>
                <div class="ui-helper-clearfix"></div>
                <% if (((MultiTrunkTreeMeasurement)Model.SelectedTreeMeasurement).TrunkMeasurements.Count == 0) { %>
                    <p>Click the button above to add a trunk measurement.</p>    
                <% } %>
            </div>
            <% for (int tm = ((MultiTrunkTreeMeasurement)Model.SelectedTreeMeasurement).TrunkMeasurements.Count - 1; tm >= 0; tm--) { %>
                <% Html.RenderPartial("TrunkMeasurementSummary",
                       ((MultiTrunkTreeMeasurement)Model.SelectedTreeMeasurement).TrunkMeasurements[tm],
                       new ViewDataDictionary(ViewData) { { "Edit", true }, { "TrunkMeasurementIndex", tm } }); %>
            <% } %>
        </div>
    </div>
</div>
