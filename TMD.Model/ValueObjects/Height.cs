...
namespace TMD.Model
{
    public class Height : ICloneable, IIsValid, IIsNull
    {
        ...
        private Height(float feet)
        {
            this.Feet = feet;
            InputFormat = EInputFormat.DecimalFeet;
        }

        private Height(float feet, EInputFormat inputFormat)
        {
            this.Feet = feet;
        ...
        public static bool operator ==(Height h1, Height h2)
        {
        ...
        public object Clone()
        {
            return new Height(Feet, InputFormat);
        }
        ...
        public IList<string> GetValidationErrors()
        {
            ...
            {
                errors.Add("Distance must be in fff.f', mmm.mm m, or yyy.yy yd format.");
            }
            if (Feet < 0f)
            {
                errors.Add("Height must be non-negative.");
            }
            return errors;
        }
        ...
        public static Height Create(string s)
        {
            Match match;
            float feet;
        ...
        public static Height Create(float feet)
        {
            return new Height(feet);
        }
    }
}
