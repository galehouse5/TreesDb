...
SET ANSI_PADDING OFF
GO
alter table [dbo].[PhotoReferences] add [ImportSubsiteId] int null
go
alter table [dbo].[PhotoReferences] add [ImportTreeId] int null
go
...
GO
ALTER TABLE [dbo].[PhotoReferences]  WITH CHECK ADD  CONSTRAINT [FK_References_Subsites] FOREIGN KEY([ImportSubsiteId])
REFERENCES [Imports].[Subsites] ([Id])
GO
ALTER TABLE [dbo].[PhotoReferences] CHECK CONSTRAINT [FK_References_Subsites]
GO
ALTER TABLE [dbo].[PhotoReferences]  WITH CHECK ADD  CONSTRAINT [FK_References_Trees] FOREIGN KEY([ImportTreeId])
REFERENCES [Imports].[Trees] ([Id])
GO
ALTER TABLE [dbo].[PhotoReferences] CHECK CONSTRAINT [FK_References_Trees]
GO
...
set identity_insert [dbo].[PhotoReferences] on
insert into [dbo].[PhotoReferences] ([Id], [Type], [ImportSubsiteId], [ImportTreeId], [SubsiteId], [SubsiteVisitId], [TreeId], [MeasurementId], [PhotoFileId])
select [Id], [Type], [ImportSubsiteId], [ImportTreeId], [SubsiteId], [SubsiteVisitId], [TreeId], [MeasurementId], [PhotoFileId]
from LegacyImport_PhotoReferences
set identity_insert [dbo].[PhotoReferences] off
